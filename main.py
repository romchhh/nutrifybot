...
async def main():
    ...
    from handlers.client_handlers.ration_handlers import router as ration_router
    from handlers.client_handlers.calories_handlers import router as calories_router
    from handlers.client_handlers.profile_handlers import router as profile_router
    from handlers.client_handlers.registration_handlers import router as registration_router
    ...
    dp.include_router(ration_router)
